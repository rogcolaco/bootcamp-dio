...
public class ExceptionsHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<ExceptionsResponse> handleSecurrity(BusinessException e){
        return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY).body(new ExceptionsResponse((e.getMessage())));
    }

    @ExceptionHandler(NotFoundException.class)
    protected ResponseEntity<ExceptionsResponse> handleSecurrity(NotFoundException e){
